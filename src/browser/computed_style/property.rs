...
pub enum PropertyId {
    ...
    ExperimentalAnchorName,
    /// EXPERIMENTAL CSS Anchor Positioning L1: position-anchor.
    ExperimentalPositionAnchor,
    /// EXPERIMENTAL CSS Anchor Positioning L1: inset-area.
    ExperimentalInsetArea,
    /// EXPERIMENTAL CSS View Transitions L1: view-transition-name.
    ExperimentalViewTransitionName,
    /// EXPERIMENTAL CSS Scroll-Driven Animations L1: view/scroll-timeline-*.
    ExperimentalViewTimelineName,
    ExperimentalViewTimelineAxis,
    ExperimentalScrollTimelineName,
    ExperimentalScrollTimelineAxis,
    ExperimentalAnimationTimeline,
    /// EXPERIMENTAL CSS Containment L3: content-visibility, container-*.
    ExperimentalContentVisibility,
    ExperimentalContainer,
    ExperimentalContainerType,
    ExperimentalContainerName,
    /// EXPERIMENTAL CSS Text L4: text-wrap, text-wrap-style, text-wrap-mode.
    ExperimentalTextWrap,
    ExperimentalTextWrapStyle,
    ExperimentalTextWrapMode,
    /// EXPERIMENTAL CSS Inline L3: text-box-trim, text-box-edge.
    ExperimentalTextBoxTrim,
    ExperimentalTextBoxEdge,
    /// EXPERIMENTAL CSS Forms L1: field-sizing.
    ExperimentalFieldSizing,
    /// EXPERIMENTAL CSS Color L4: print-color-adjust, forced-color-adjust, color-scheme.
    ExperimentalPrintColorAdjust,
    ExperimentalForcedColorAdjust,
    ExperimentalColorScheme,
    /// EXPERIMENTAL CSS Math L3: math-style, math-depth.
    ExperimentalMathStyle,
    ExperimentalMathDepth,
    /// EXPERIMENTAL CSS Ruby L1: ruby-position, ruby-align.
    ExperimentalRubyPosition,
    ExperimentalRubyAlign,
    /// EXPERIMENTAL CSS Overflow L4: scroll-marker-group.
    ExperimentalScrollMarkerGroup,
...
impl PropertyId {
    ...
    pub fn parse(s: &str) -> Self {
        match s.trim().to_lowercase().as_str() {
            ...
            "inset-area" => Self::ExperimentalInsetArea,
            "view-transition-name" => Self::ExperimentalViewTransitionName,
            "view-timeline-name" => Self::ExperimentalViewTimelineName,
            "view-timeline-axis" => Self::ExperimentalViewTimelineAxis,
            "scroll-timeline-name" => Self::ExperimentalScrollTimelineName,
            "scroll-timeline-axis" => Self::ExperimentalScrollTimelineAxis,
            "animation-timeline" => Self::ExperimentalAnimationTimeline,
            "content-visibility" => Self::ExperimentalContentVisibility,
            "container" => Self::ExperimentalContainer,
            "container-type" => Self::ExperimentalContainerType,
            "container-name" => Self::ExperimentalContainerName,
            "text-wrap" => Self::ExperimentalTextWrap,
            "text-wrap-style" => Self::ExperimentalTextWrapStyle,
            "text-wrap-mode" => Self::ExperimentalTextWrapMode,
            "text-box-trim" => Self::ExperimentalTextBoxTrim,
            "text-box-edge" => Self::ExperimentalTextBoxEdge,
            "field-sizing" => Self::ExperimentalFieldSizing,
            "print-color-adjust" => Self::ExperimentalPrintColorAdjust,
            "forced-color-adjust" => Self::ExperimentalForcedColorAdjust,
            "color-scheme" => Self::ExperimentalColorScheme,
            "math-style" => Self::ExperimentalMathStyle,
            "math-depth" => Self::ExperimentalMathDepth,
            "ruby-position" => Self::ExperimentalRubyPosition,
            "ruby-align" => Self::ExperimentalRubyAlign,
            "scroll-marker-group" => Self::ExperimentalScrollMarkerGroup,
            _ => Self::Unknown,
        }
    }
    ...
    pub fn css_name(self) -> &'static str {
        match self {
            ...
            Self::ExperimentalInsetArea => "inset-area",
            Self::ExperimentalViewTransitionName => "view-transition-name",
            Self::ExperimentalViewTimelineName => "view-timeline-name",
            Self::ExperimentalViewTimelineAxis => "view-timeline-axis",
            Self::ExperimentalScrollTimelineName => "scroll-timeline-name",
            Self::ExperimentalScrollTimelineAxis => "scroll-timeline-axis",
            Self::ExperimentalAnimationTimeline => "animation-timeline",
            Self::ExperimentalContentVisibility => "content-visibility",
            Self::ExperimentalContainer => "container",
            Self::ExperimentalContainerType => "container-type",
            Self::ExperimentalContainerName => "container-name",
            Self::ExperimentalTextWrap => "text-wrap",
            Self::ExperimentalTextWrapStyle => "text-wrap-style",
            Self::ExperimentalTextWrapMode => "text-wrap-mode",
            Self::ExperimentalTextBoxTrim => "text-box-trim",
            Self::ExperimentalTextBoxEdge => "text-box-edge",
            Self::ExperimentalFieldSizing => "field-sizing",
            Self::ExperimentalPrintColorAdjust => "print-color-adjust",
            Self::ExperimentalForcedColorAdjust => "forced-color-adjust",
            Self::ExperimentalColorScheme => "color-scheme",
            Self::ExperimentalMathStyle => "math-style",
            Self::ExperimentalMathDepth => "math-depth",
            Self::ExperimentalRubyPosition => "ruby-position",
            Self::ExperimentalRubyAlign => "ruby-align",
            Self::ExperimentalScrollMarkerGroup => "scroll-marker-group",
