...
fn make_canvas_gradient_linear(x0: f32, y0: f32, x1: f32, y1: f32) -> JsValue {
...
fn make_canvas_gradient_radial(x0: f32, y0: f32, r0: f32, x1: f32, y1: f32, r1: f32) -> JsValue {
    let stops: Rc<RefCell<Vec<(f32, [u8; 4])>>> = Rc::new(RefCell::new(Vec::new()));
    let obj = Rc::new(RefCell::new(JsObject::new()));
...
fn serialize_outer_html(node: &Rc<crate::browser::dom::NodeData>) -> String {
    use crate::browser::dom::NodeKind;
    match &node.kind {
        NodeKind::Element(_) => {
