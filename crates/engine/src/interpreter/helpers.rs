...
/// Postavi DataTransfer JS object (drag&drop). setData/getData/clearData nad
/// sdilenym HashMap. Stejna instance (sdileny map) se predava do dragstart ->
/// dragover -> drop = data nastavena v dragstart cte drop pres getData.
/// Pouziti z webview drag state machine i z `new DataTransfer()` builtinu.
pub fn make_data_transfer() -> JsValue {
